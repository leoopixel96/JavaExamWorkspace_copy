...
import zs.ui.fx.MainPaneMvvm;
import zs.ui.fx.MainViewModel;
import zs.ui.swing.SwingUserInteractor;

public class ShipmentsApplicationMvvm extends Application {
	...
	public void start(Stage stage) {
		...
		MainViewModel viewModel = new MainViewModel(controller);
		stage.setTitle("ZShipments");
		
		BorderPane root = new MainPaneMvvm(viewModel);
